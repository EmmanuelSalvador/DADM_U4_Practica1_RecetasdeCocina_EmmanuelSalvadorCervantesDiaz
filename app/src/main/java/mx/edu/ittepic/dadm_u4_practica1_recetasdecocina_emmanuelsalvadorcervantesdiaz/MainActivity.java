...
public class MainActivity extends AppCompatActivity {
    ...
    private void aplicarActualizar() {
        ...
        try{
            ...
            String SQL= "UPDATE RECETAS SET NOMBRE='"+nombre.getText().toString()+"', INGREDIENTES='"+ingredientes.getText().toString()+"', PREPARACION='"+preparacion.getText().toString()+"', OBSERVACIONES='"+observaciones.getText().toString()+"' WHERE ID="+identificacion.getText().toString();
            tabla.execSQL(SQL);
            tabla.close();
    ...
    private void codigoInsertar() {
        try{
            SQLiteDatabase tabla = base.getWritableDatabase();
            String SQL = "INSERT INTO RECETAS VALUES("+identificacion.getText().toString()+",'"+nombre.getText().toString()+"','"+ingredientes.getText().toString()+"','"+preparacion.getText().toString()+"','"+observaciones.getText().toString()+"')";
    ...
    private void invocarConfirmacionEliminar(String dato) {
        ...
        AlertDialog.Builder alerta = new AlertDialog.Builder(this);
        alerta.setTitle("IMPORTANTE").setMessage("¿Seguro que deseas eliminar la siguiente receta: "+nombre+"?")
                .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
